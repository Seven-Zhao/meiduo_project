...
_accountSid = '2c94811c9860a9c4019a43d0a6634604'

# 说明：主账号Token，登陆云通讯网站后，可在控制台-应用中看到开发者主账号AUTH TOKEN
_accountToken = '9c68bd66ed184ca1a9e40faccad94788'

# 请使用管理控制台首页的APPID或自己创建应用的APPID
_appId = '2c94811c9860a9c4019a43d0a823460b'
...
if __name__ == '__main__':
    ...
    # 单例类发送短信验证码
    CCP().send_template_sms('15013632916', ['123456', 5], 1)
